      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-6">
          ...
          <div className="bg-blue-100 p-4 rounded">
            ...
            <p className="text-lg">
              <strong>Variation:</strong> <span className="font-mono text-2xl text-blue-600">{variation}</span>
            </p>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-6">
          ...
          {variation === "A" ? (
            <div className="bg-red-100 border-4 border-red-500 p-8 rounded-lg text-center">
              <h3 className="text-3xl font-bold text-red-700 mb-4">🔴 Version A Layout</h3>
              <p className="text-lg text-red-600">This is what users in variation A see</p>
            </div>
          ) : (
            <div className="bg-green-100 border-4 border-green-500 p-8 rounded-lg text-center">
              <h3 className="text-3xl font-bold text-green-700 mb-4">🟢 Version B Layout</h3>
              <p className="text-lg text-green-600">This is what users in variation B see</p>
            </div>
          )}
        </div>
        ...
        <div className="mt-8 bg-yellow-50 border-2 border-yellow-300 p-6 rounded-lg">
          ...
          <p className="mb-3">Open your browser console and run this to see analytics:</p>
